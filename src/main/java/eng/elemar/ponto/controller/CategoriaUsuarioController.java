...
import eng.elemar.ponto.service.CategoriaUsuarioService;
...
public class CategoriaUsuarioController {
    ...
    public ResponseEntity<CategoriaUsuarioDTO> save(@RequestBody CategoriaUsuarioDTO dto){
    ...
    public ResponseEntity<CategoriaUsuarioDTO> findById(@PathVariable Long id){
