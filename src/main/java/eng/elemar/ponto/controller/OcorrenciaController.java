...
import eng.elemar.ponto.service.OcorrenciaService;
...
public class OcorrenciaController {
    ...
    public ResponseEntity<OcorrenciaDTO> save(@RequestBody OcorrenciaDTO dto){
        return ResponseEntity.ok(service.save(dto));
    }

    @PutMapping(consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<OcorrenciaDTO> update(@RequestBody OcorrenciaDTO dto){
