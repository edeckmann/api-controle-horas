...
import eng.elemar.ponto.service.CalendarioService;
...
public class CalendarioController {
    ...
    public ResponseEntity<CalendarioDTO> save(@RequestBody CalendarioDTO dto){
        return ResponseEntity.ok(service.save(dto));
    }

    @PutMapping(consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<CalendarioDTO> update(@RequestBody CalendarioDTO dto){
