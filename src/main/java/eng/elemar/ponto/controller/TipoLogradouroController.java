...
import eng.elemar.ponto.service.TipoLogradouroService;
...
public class TipoLogradouroController {
    ...
    public ResponseEntity<TipoLogradouroDTO> save(@RequestBody TipoLogradouroDTO dto){
        return ResponseEntity.ok(service.save(dto));
    }

    @PutMapping(consumes = MediaType.APPLICATION_JSON_VALUE,produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<TipoLogradouroDTO> update(@RequestBody TipoLogradouroDTO dto){
